...
export const copy = {
  ...
  features: {
    visibility: {
      ...
      shortDescription:
        'Monitor every prompt, response, and tool call. See token usage, latency, and full execution flow.',
      points: [
        'Full prompt history',
        'Tool execution logs',
    ...
    setup: {
      ...
      shortDescription:
        'Just change your base URL. Works with Claude, GPT-4, and any other LLM provider instantly.',
      points: [
        'One-line setup',
