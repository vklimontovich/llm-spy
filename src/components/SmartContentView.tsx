...
export default function SmartContentView({ data, className = '' }: SmartContentViewProps) {
  ...
  if (typeof data === 'string') {
    try {
      ...
      return (
        <pre className={`text-xs font-mono overflow-auto whitespace-pre-wrap text-gray-800 leading-relaxed ${className}`}>
          {data}
        </pre>
      )
    }
